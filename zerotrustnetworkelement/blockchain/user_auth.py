...
from zerotrustnetworkelement.blockchain.sc_function import query_gid, query_bc_pk, query_gw_pk, \
...
def user_auth(gw_socket, loop, cli, org_admin, bc_ip):
    ...
    try:
        ...
        '''查询gid状态'''
        gid_state = query_gid(loop, cli, org_admin, bc_ip, gw_id)
